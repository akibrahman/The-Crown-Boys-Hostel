  ...
  return (
    <div className="">
      ...
      <div className={`relative ${deviceWidth <= 500 ? "" : "hidden"}`}>
        ...
        <div
          className={`duration-300 ease-linear transition-all flex flex-col items-center justify-center gap-5 md:gap-10 dark:bg-gradient-to-r dark:from-primary dark:to-secondary bg-white text-black dark:text-white py-5 absolute wfull ${
