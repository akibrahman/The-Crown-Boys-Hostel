...
const DateRangeMealOrderManager = ({
  dateRangePopUp,
  setDateRangePopUp,
  // currentDate,
  currentMonth,
  ...
  const saveOrder = async () => {
    ...
    try {
      const { data: resData } = await axios.put("/api/orders/m", {
        data,
        userId: user._id,
        fromDate,
        toDate,
  ...
  // if (!myMealRequests && dateRangePopUp) return <PreLoader />;
  return (
    <Modal
      isOpen={dateRangePopUp}
...
export default DateRangeMealOrderManager;
